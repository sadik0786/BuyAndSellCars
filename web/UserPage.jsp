<%-- 
    Document   : UserPage
    Created on : 5 Jun, 2017, 2:26:00 PM
    Author     : Sadik
--%>
...
<html>
    <head>
       ...
       <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="stylesheet" type="text/css" href="cssstyle/UserPage.css">
...
<body>
        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="GalleryUser.html" role="button" target="NavigationFrame">See More Cars</a></p>
            </div>
          </div>
        </div>
        <div class="item">
    ...
    <div class="container">
        ...
        <a href="BuyingPage1.jsp" class="button">Buy A Car</a>
        <a href="SellCarPage.jsp" class="button">Sell A Car</a>
        <a href="ComparePage.jsp" class="button">Compare A Car</a>
    </div>
