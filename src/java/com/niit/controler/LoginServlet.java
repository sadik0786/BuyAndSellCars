...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            UserInfo user = userDAO.getUserByLoginId(loginId);
            if(user!=null)
            {
                System.out.println("password " + user.getPass() + " " + password + " " + user.getUsertype());
                if(user.getPass().trim().equals(password.trim()))
                {
                    ...
                    else if(user.getUsertype().trim().equals("Customer"))
                    {
